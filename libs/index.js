...
var Component = (function () {
    function Component(vm, parent, Byy) {
    ...
    Component.prototype.__transferDatas = function () {
        Object.assign(this, __assign(__assign({}, this.props), this.data));
    };
...
var Byy = (function (_super) {
    __extends(Byy, _super);
    function Byy(options) {
    ...
    Byy.prototype._init = function (pass) {
        if (pass === "byy") {
    ...
    Byy.prototype._triggerMounter = function (childs) {
